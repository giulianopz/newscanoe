...
If such file does not already exist, it will be created at the first execution of the app and you will be prompted to manually insert a url by typing `a`. Otherwise you are free to create such file with any text editor. You can also change the name of a feed by editing the same file.
